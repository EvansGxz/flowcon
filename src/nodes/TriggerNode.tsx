...
const TriggerNode = ({ data, selected, id }: TriggerNodeProps) => {
  ...
  const definition = data.typeId ? nodeRegistry.get(data.typeId) : undefined;
  const displayName = data.displayName || definition?.displayName || (data.label as string) || 'Trigger';
