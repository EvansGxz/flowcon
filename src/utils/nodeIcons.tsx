...
export function getNodeIcon(iconString: string | React.ComponentType, color: string = '#6366f1'): React.ReactElement {
  // Si ya es un componente React, retornarlo
  if (typeof iconString !== 'string') {
    const IconComponent = iconString as React.ComponentType<{ size?: number; color?: string }>;
