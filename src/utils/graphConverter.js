 ...
 */
export function reactFlowNodesToBaseNodes(reactFlowNodes) {
  if (!Array.isArray(reactFlowNodes)) {
    return [];
  }
  return reactFlowNodes.map((node) => ({
    id: String(node.id), // Preservar ID original al exportar
    type: mapTypeIdToNodeType(node.data?.typeId),
 ...
 */
export function reactFlowEdgesToEdges(reactFlowEdges) {
 ...
 */
export function reactFlowToGraphDefinition(reactFlowNodes, reactFlowEdges, graphId = 'default') {
 ...
 */
export function baseNodesToReactFlow(baseNodes) {
 ...
 */
export function edgesToReactFlow(edges) {
 ...
 */
export function graphDefinitionToReactFlow(graphDefinition) {
  if (!graphDefinition) {
    return { nodes: [], edges: [] };
  }
 ...
 */
function mapTypeIdToNodeType(typeId) {
  const mapping = {
 ...
 */
function mapNodeTypeToTypeId(nodeType) {
  const mapping = {
 ...
 */
function getReactFlowTypeName(nodeType) {
