import { useState, useEffect, useRef, ChangeEvent, MouseEvent, KeyboardEvent, type ReactElement } from 'react';
import { ChevronLeft, X, ChevronRight } from 'lucide-react';
import { nodeRegistry, NodeCategory, type NodeCategoryValue } from '../../nodes/definitions';
import { getCategoryMetadata } from '../../utils/categoryIcons';
import { getNodeIcon } from '../../utils/nodeIcons';
import type { NodeDefinition } from '../../nodes/definitions/NodeDefinition';
...
const NodePalette = ({ onAddNode, isOpen, onClose, connectionFilter = null }: NodePaletteProps) => {
  const [selectedCategory, setSelectedCategory] = useState<NodeCategoryValue | null>(null);
  ...
  const categories = Object.values(NodeCategory) as NodeCategoryValue[];
  ...
  let filteredNodes: NodeDefinition[] = [];
  if (showCategories) {
    ...
    if (connectionFilter) {
      const { handleType } = connectionFilter;
  ...
  const handleCategoryClick = (category: NodeCategoryValue) => {
