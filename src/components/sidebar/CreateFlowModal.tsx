...
const CreateFlowModal = ({ isOpen, onClose, onCreate, projectName }: CreateFlowModalProps) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Error al crear el flujo';
